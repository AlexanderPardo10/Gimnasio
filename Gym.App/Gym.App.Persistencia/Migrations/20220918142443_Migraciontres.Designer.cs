...
namespace Gym.App.Persistencia.Migrations
{
    ...
    [Migration("20220918142443_Migraciontres")]
            ...
            modelBuilder.Entity("Gym.App.Dominio.Exercise", b =>
                {
                    ...
                    b.Property<int>("ConsecutivoIntensidad")
                        .HasColumnType("int");

                    b.Property<int>("ConsumedCalories")
                        .HasColumnType("int");

                    b.Property<string>("ExerciseConditions")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("TiempoDedidado")
                        .HasColumnType("int");

                    b.Property<string>("UrlExercise")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Gym.App.Dominio.Customer", b =>
                {
                    ...
                    b.HasOne("Gym.App.Dominio.Routine", "RoutineExercise")
                        .WithMany()
